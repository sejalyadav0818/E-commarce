...
let ProductService = class ProductService {
    ...
    async createUser(dto, req, category_id, file) {
    ...
    async usersAllProducts(req, res) {
        try {
            ...
            console.log(...oo_oo(`935c2b04_0`, products));
            console.log(...oo_oo(`935c2b04_1`, "pwithc", products[0].catrgory[0].category_name));
            return { products };
        }
        catch (err) {
            throw err;
    ...
    async search(req, res) {
        try {
            ...
            console.log(...oo_oo(`935c2b04_2`, 'searched d', search));
            return search;
        }
        catch (error) {
            throw error;
