...
function ObjectType(nameOrOptions, objectTypeOptions) {
    ...
    return (target) => {
        ...
        const addObjectTypeMetadata = () => {
            var _a;
            return type_metadata_storage_1.TypeMetadataStorage.addObjectTypeMetadata({
                name: name || target.name,
                target,
                description: (parentType === null || parentType === void 0 ? void 0 : parentType.inheritDescription)
                    ? (_a = options.description) !== null && _a !== void 0 ? _a : parentType === null || parentType === void 0 ? void 0 : parentType.description
                    : options.description,
